...
void get_ID()
{
    ...
    // find the FR shoulder stateid
    FR_shoulder_stateid[0] = pos_FR_shoulder_adr;
    FR_shoulder_stateid[1] = pos_FR_shoulder_adr+1;
    FR_shoulder_stateid[2] = pos_FR_shoulder_adr+2;
               ...
               double pos_FR_foot[3],double pos_FL_foot[3],double pos_RR_foot[3],double pos_RL_foot[3],double robot_com[3])
{
    ...
    // find the FR_shoulder position
    for (i=0; i<3; i++)
    {
        pos_FR_shoulder[i]=d->sensordata[FR_shoulder_stateid[i]];
    }
...
void loop(const mjModel* m, mjData* d)
{
    ...
    // checking
    // printf("compare the real foot position with the reference foot position to verify the solvers' correctness\n");
    // printf("pos_FR_foot_x, pos_FR_foot_y, pos_FR_foot_z: %f %f %f\n", pos_FR_foot[0], pos_FR_foot[1], pos_FR_foot[2]);
    // printf("pos_FL_foot x, z: %f %f\n", pos_FL_foot[0], pos_FL_foot[2]);
    // printf("*************************\n");
