...
void loop(const mjModel* m, mjData* d)
{
    ...
    // check the shoulder/elbow/foot position
    printf("*******************************\n");
    printf("FR_shoulder xyz is %f %f %f \n", pos_FR_shoulder[0], pos_FR_shoulder[1], pos_FR_shoulder[2]);
    printf("FL_shoulder xyz is %f %f %f \n", pos_FL_shoulder[0], pos_FL_shoulder[1], pos_FL_shoulder[2]);
    printf("RR_shoulder xyz is %f %f %f \n", pos_RR_shoulder[0], pos_RR_shoulder[1], pos_RR_shoulder[2]);
    printf("RL_shoulder xyz is %f %f %f \n", pos_RL_shoulder[0], pos_RL_shoulder[1], pos_RL_shoulder[2]);
    printf("\n");

    printf("FR_elbow xyz is %f %f %f \n", pos_FR_elbow[0], pos_FR_elbow[1], pos_FR_elbow[2]);
    printf("FL_elbow xyz is %f %f %f \n", pos_FL_elbow[0], pos_FL_elbow[1], pos_FL_elbow[2]);
    printf("RR_elbow xyz is %f %f %f \n", pos_RR_elbow[0], pos_RR_elbow[1], pos_RR_elbow[2]);
    printf("RL_elbow xyz is %f %f %f \n", pos_RL_elbow[0], pos_RL_elbow[1], pos_RL_elbow[2]);
    printf("\n");

    printf("FR_foot xyz is %f %f %f \n", pos_FR_foot[0], pos_FR_foot[1], pos_FR_foot[2]);
    printf("FL_foot xyz is %f %f %f \n", pos_FL_foot[0], pos_FL_foot[1], pos_FL_foot[2]);
    printf("RR_foot xyz is %f %f %f \n", pos_RR_foot[0], pos_RR_foot[1], pos_RR_foot[2]);
    printf("RL_foot xyz is %f %f %f \n", pos_RL_foot[0], pos_RL_foot[1], pos_RL_foot[2]);
    printf("*******************************\n");
